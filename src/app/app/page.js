...
export default async function App() {
	...
	const userData = await User.findOne({ email: user.email }).populate("urls");
	const data = await Url.find({ user: userData._id }).populate("clicks");
	return <main className="dark:text-white">dashboard</main>;
}
...
//         const response = await fetch("/api/urls?id=" + activeUrlData.data._id, {
//             method: "DELETE",
//             headers: {
